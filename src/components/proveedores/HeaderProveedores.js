...
const HeaderProveedores = () => {
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        setTimeout(() => navigate(`../proveedores/buscar/${term}`), 0.2);
        setTerm("");
    };
    ...
    return(
        <>
            <div className="mb-12 text-left md:text-center">
            ...
            </div><div className="mb-3 md:w-full">
                <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                    ...
                    <Link
                        to="crear"
                        className="bg-amber-500 py-2 px-4 mx-3 rounded-lg font-bold text-white hover:bg-black hover:text-amber-500"
                    >
                        Añadir proveedor
                    </Link>
                </div>
...
export default HeaderProveedores;
